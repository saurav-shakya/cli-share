...
3.  Execute the `cli-share` command non-interactively based on their choice:
    - If Full + Public: `npx @saurav-shakya/cli-share --full --public`
    - If Full + Private: `npx @saurav-shakya/cli-share --full --private`
    - If Range (e.g. 10-20) + Public: `npx @saurav-shakya/cli-share --range=10-20 --public`
    - If Range + Private: `npx @saurav-shakya/cli-share --range=10-20 --private`
